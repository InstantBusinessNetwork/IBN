#ifndef _ATL_NETLIBCP_H_
#define _ATL_NETLIBCP_H_
...
public:
	HRESULT Fire_ChangedState(LONG State, LONG ErrorType, LONG ErrorCode)
	{
	...
	HRESULT Fire_eChangedStatus(IUser * pUser)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_eMessage(IMessage * pMessage)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_ePromo(IPromo * pPromo, BSTR PromoAsString)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_eFile(IFile * pFile)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_eAdd(IUser * pUser, BSTR bstrMessage)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_eAddR(IUser * User, LONG nResult)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_eReklama(BSTR bstrURL)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_ContactList(IUsers * pUsers)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_IgnoreList(LONG Handle, IUsers * pUsers)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_Details(LONG Handle, IUser * pUser, LONG type)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_CommandOK(LONG Handle, LONG AddVal)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_CommandError(LONG Handle, LONG ErrorType, LONG ErrorCode)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_SessionsList(LONG Handle, IlocalSIDs * plocalSIDs)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_OffLineFiles(LONG Handle, IFiles * pFiles)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_MessagesList(LONG Handle, IMessages * pMessages)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_PromosList(LONG Handle, IPromos * pPromos, BSTR PromosAsString)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_SelfStatus(LONG Status)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_eSysMess(LONG Code, BSTR Description)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_ChatList(IChats * pChats)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_ChatStatus(LONG Handle, IUsers * pUsers, BSTR bsLog)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_ChatCreate(LONG Handle, IChat * pChat)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_eChatUserStatus(IUser * pUser, IChat * pChat)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_eChatInvite(IChat * pChat, IUser * pUser, IUser * pInvitedFriend, BSTR Invitation)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_eChatLeave(IUser * pUser, IChat * pChat)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_eChatMessage(IChat * pChat, IMessage * pMessage)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_eChatFile(IChat * pChat)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_eChatAccept(IChat * pChat, IUser * pUser, LONG Result)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
