...
#include "resource.h"
//}}AFX_INCLUDES
#if !defined(AFX_CHAT_H__57334E4B_6FAA_4A15_AC98_5AB99FAD07E9__INCLUDED_)
#define AFX_CHAT_H__57334E4B_6FAA_4A15_AC98_5AB99FAD07E9__INCLUDED_
...
class CChatDlg : public COFSNcDlg2
{
// Construction
public:
	
	void SetChat(const CChat& Chat);
...
//	CWebBrowser2 m_HistoryChild;
	CChatDlg(CMainDlg *pMessenger,CWnd* pParent = NULL);   // standard constructor
	~CChatDlg();
...
protected:
	...
	afx_msg void OnClickBtnUsers();
	afx_msg void OnClickBtnFiles();
...
#endif // !defined(AFX_CHAT_H__57334E4B_6FAA_4A15_AC98_5AB99FAD07E9__INCLUDED_)
