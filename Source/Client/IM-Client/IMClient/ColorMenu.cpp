...
void CColorMenu::DrawItem(LPDRAWITEMSTRUCT lpDIS)
{
	...
	rc.left += 4;rc.top += 2;
	rc.bottom -= 2;rc.right = rc.left + 45;
	if(id==ID_COLOR16)
	{
		dc.DrawText(CString(_T("...")),rc,DT_LEFT|DT_SINGLELINE|DT_VCENTER);
	}
	else
	{
...
void CColorMenu::MeasureItem(LPMEASUREITEMSTRUCT lpMIS)
{
	...
	lpMIS->itemWidth = 40;//sizeText.cx + 20;
	lpMIS->itemHeight = 15;//sizeText.cy;
}
