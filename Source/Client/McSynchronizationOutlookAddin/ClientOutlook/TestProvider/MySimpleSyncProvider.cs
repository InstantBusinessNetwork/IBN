...
{
	public class MySyncProvider : KnowledgeSyncProvider, IChangeDataRetriever, INotifyingChangeApplierTarget, ISyncProviderSetting
    {
		...
		{
			get { return ConflictResolutionPolicy.ApplicationDefined; }
		}

		public SyncDirectionOrder SyncDirectionOrderSetting
		{
			get { return SyncDirectionOrder.DownloadAndUpload; }
		}
