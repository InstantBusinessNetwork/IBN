...
{
    public partial class MCActivate : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            divTitle.InnerHtml = LocRM.GetString("MC_YouAreReady");
            divMess.InnerHtml = "<i>" + LocRM.GetString("MC_PressActivate") + "</i>";
            ...
            divFailed.InnerHtml = LocRM.GetString("MC_PleaseCheck") + LocRM.GetString("MC_Assist");
            //string asppath = Settings.AspPath;
            //if (asppath != null)
            //    imgHeader.ImageUrl = asppath + "images/SignupHeader.aspx";

            Page.ClientScript.RegisterStartupScript(this.GetType(), Guid.NewGuid().ToString(), "ActivatePortal('MCActivatePortal.aspx?reqId=" + RequestID + "&guid=" + _Guid + "&locale=" + locale + "', '" + divMess.ClientID + "', '" + divTitle.ClientID + "');", true);
        }
    }
}
