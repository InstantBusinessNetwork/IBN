<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PmBoxActivate.aspx.cs" Inherits="Mediachase.Ibn.WebTrial.PmBoxActivate" %>
...
<HTML>
	...
	<body style="TEXT-ALIGN: center" class="pmreg_body">
        ...
        function ActivatePortal(feedUrl, containerId, containerTitleId, errorContainerId)
        {
          ...
          document.getElementById(containerTitleId).innerHTML = '<%= LocRM.GetString("PmBox_ActProgress")%>';
          var ajaxRequest;
          ...
          ajaxRequest.onreadystatechange = function()
          {
            if(ajaxRequest.readyState == 4)
            {
              ...
              if(ajaxRequest.responseText=="0")
              {
                ...
                document.getElementById(containerTitleId).innerHTML = '<%= LocRM.GetString("PmBox_ActivationError")%>';
              }
              else
              {
                document.getElementById(containerId).innerHTML = ajaxRequest.responseText;
                document.getElementById(containerTitleId).innerHTML = '<%= LocRM.GetString("PmBox_Congratulations")%>';
              }
            }
	        }
