...
{
    public partial class MCActivatePortal : System.Web.UI.Page
    {
        #region reqId
        private int reqId
        {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    string activatedString = String.Format(LocRM.GetString("MC_Activated"), portalUrl, login, password);
                    retVal = activatedString + LocRM.GetString("MC_Assist");
                }
                catch
                {
#if !DEBUG
