...
{
	public partial class ActivatePortal : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			else
			{
				...
				try
				{
					...
					string activatedString = String.Format(LocRM.GetString("Activated"), portalUrl, login, password);
					retVal = activatedString + LocRM.GetString("Assist");
				}
				catch
				{
					#if !DEBUG
