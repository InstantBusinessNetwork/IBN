<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProjectTaskBusReport.ascx.cs" Inherits="Mediachase.Ibn.Apps.ClioSoft.Modules.ProjectTaskBusReport" %>
	...
	<table cellpadding="5" cellspacing="0" border="0" class="text">
		<tr>
			<td class="ibn-label" style="width:170px;">
				<%=LocRM.GetString("Grouping")%>:
			</td>
			<td>
				<asp:DropDownList runat="server" ID="GroupingList" Width="400"></asp:DropDownList>
			</td>
		</tr>
		<tr>
			<td class="ibn-label">
				<%=LocRM.GetString("RegPeriod")%>:
			</td>
			<td>
		...
		<tr>
			...
			<td>
				<mc:MultiSelect runat="server" ID="ManagerControl" Width="400" />
			</td>
		</tr>
		<tr>
			<td class="ibn-label">
