...
namespace Mediachase.Ibn.ConfigurationUI.Wizard
{
	...
	public class WizardDesigner : ParentControlDesigner
	{
		...
		//				
		//				if (ss.PrimarySelection is Mediachase.Ibn.ConfigurationUI.Wizard.Wizard)
		//				{
		//					 Mediachase.Ibn.ConfigurationUI.Wizard.Wizard wizard =  (Mediachase.Ibn.ConfigurationUI.Wizard.Wizard) ss.PrimarySelection;
