...
namespace Mediachase.Ibn.ConfigurationUI.Wizard
{
	/// <summary>
	...
	/// are of the wizard.
	/// </summary>
	[Designer(typeof(Mediachase.Ibn.ConfigurationUI.Wizard.WizardDesigner))]
	[ToolboxItem(true)]
	[ToolboxBitmap(typeof(Mediachase.Ibn.ConfigurationUI.Wizard.Wizard))]
	public class Wizard : System.Windows.Forms.UserControl
	{
		//public const string NextButtonText = "&Next >";
		//public const string FinishButtonText = "Fi&nish";
		...
		private string _backButtonText = SnapInResources.Wizard_BackButton;
		private string _nextButtonText = SnapInResources.Wizard_NextButton;
		private string _finishButtonText = SnapInResources.Wizard_FinishButton;
		private string _cancelButtonText = SnapInResources.Wizard_CancelButton;
		...
		private void InitializeComponent()
		{
			...
			this.btnCancel.Text = this.CancelButtonText;
			...
			this.btnNext.Text = this.NextButtonText;
			...
			this.btnBack.Text = this.CancelButtonText;
...
//			}
		...
		protected internal void ActivatePage(WizardPage page)
		{
			...
			btnBack.Text = this.BackButtonText;
			...
			{
				btnNext.Text = this.NextButtonText;//"&Next >";
			...
			{
				btnNext.Text = this.FinishButtonText; //"Fi&nish";
