...
{
	partial class UpdateServerForm
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(UpdateServerForm));
			...
			this.wizardPage1Info.ShowFromNext += new System.EventHandler(this.wizardPage1Info_ShowFromNext);
			// 
			// label7
			// 
