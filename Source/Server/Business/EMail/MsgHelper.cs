...
namespace Mediachase.IBN.Business.EMail
{
	...
	internal class MsgHelper : IDisposable
	{
		...
		{
			IntPtr glbPtr = Marshal.AllocHGlobal((int)stream.Length);
		...
		public void SetBody(string body)
		{
			if (body==null)
			{
				Set("__substg1.0_1000001E", 0x1000001E, "[body not available]");
			}
			else Set("__substg1.0_1000001E", 0x1000001E, body);
		}
		...
		public void SetHtmlBody(string htmlbody)
		{
			...
			else SetUTF("__substg1.0_1013001E", 0x1013001E, @"<html><\html>");
		}
		...
		public void createMSG(Stream stream)
		{
			...
			NativeCalls.GetHGlobalFromILockBytes(comPtr, out glbPtr);
