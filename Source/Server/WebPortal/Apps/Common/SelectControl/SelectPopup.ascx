<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SelectPopup.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.SelectPopup" %>
...
<div id="divClose" runat="server" style="cursor:pointer;position: absolute; left: 382px; top:2px; height: 16px; width: 16px; z-index: 10002;">
	<img alt="" src='<% =ResolveUrl("~/images/IbnFramework/deny_black.gif") %>' />
</div>
		...
		<td style="padding-top:10px;">
            ...
            <Columns>
                ...
                <asp:TemplateField ItemStyle-Width="16px">
					<ItemStyle CssClass="ibn-rowTable" />
					<ItemTemplate>
						<asp:ImageButton ImageAlign="AbsMiddle" runat="server" ID="btnSave" ImageUrl="~/Images/IbnFramework/select.gif" CommandName="Save" CommandArgument='<%# Eval("PrimaryKeyId") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
            </asp:GridView>	
