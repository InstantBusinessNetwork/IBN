<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChartReport.ascx.cs" Inherits="Mediachase.UI.Web.Apps.HelpDeskManagement.Workspace.ChartReport" %>
...
<table class="ibn-navline ibn-alternating text" cellpadding="5" cellspacing="0" width="100%" border="0" style="padding-left: 10px;">
	<tr>
		<td style="padding-top: 5px; padding-bottom: 5px;">
			<asp:Literal runat="server" Text="<%$Resources : IbnFramework.Incident, _mc_GroupType %>" />:
			<%=this.groupBy %>
		</td>
	</tr>
</table>
