<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MCGrid.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.MCGrid" %>
...
<ContentTemplate>
	<mc3:IbnGridView runat="server" ID="MainGrid"				
		...
		<PagerStyle CssClass="serverGridFooter" BorderWidth="0px" Height="18px"/>
