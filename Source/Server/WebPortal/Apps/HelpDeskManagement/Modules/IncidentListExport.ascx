<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IncidentListExport.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.HelpDeskManagement.Modules.IncidentListExport" %>
<style type="text/css">
	.pad5 tbody tr td
	{
		padding: 5px;
