<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RoleMultiValue.Manage.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.Security.Primitives.RoleMultiValue_Manage" %>
