<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GlobalRoleAclStateEdit.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.Apps.Security.Modules.ManageControls.GlobalRoleAclStateEdit" %>
