<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ObjectRoleStateTransitionEdit.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.Apps.Security.Modules.ManageControls.ObjectRoleStateTransitionEdit" %>
<table style="width:100%;"><tr><td style="padding:10px;">
	<table cellpadding="3" cellspacing="0" border="0" width="100%" class="ibn-propertysheet" style="table-layout:fixed">
		<tr>
			...
			<td>
				<asp:TextBox runat="server" ID="txtName" MaxLength="100" Width="100%" Enabled="false"></asp:TextBox>
			</td>
		</tr>
		<tr>
			<td valign="top">
			...
			<td>
				<div style="border:2px inset;overflow-y:auto;height:110px;">
