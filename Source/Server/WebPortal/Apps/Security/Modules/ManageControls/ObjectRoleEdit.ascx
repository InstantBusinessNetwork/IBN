<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ObjectRoleEdit.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.Apps.Security.Modules.ManageControls.ObjectRoleEdit" %>
