<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GlobalRoleAclStateTransitionEdit.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.Apps.Security.Modules.ManageControls.GlobalRoleAclStateTransitionEdit" %>
