<%@ Control Language="C#" AutoEventWireup="true" ClassName="Mediachase.UI.Web.Apps.MetaUI.Primitives.Duration_Grid" Inherits="Mediachase.Ibn.Web.UI.Controls.Util.BaseType" %>
