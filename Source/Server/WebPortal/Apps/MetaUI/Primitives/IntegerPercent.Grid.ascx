<%@ Control Language="C#" AutoEventWireup="true" Inherits="Mediachase.Ibn.Web.UI.Controls.Util.BaseType" ClassName="Mediachase.UI.Web.Apps.MetaUI.Primitives.IntegerPercent_Grid" %>
