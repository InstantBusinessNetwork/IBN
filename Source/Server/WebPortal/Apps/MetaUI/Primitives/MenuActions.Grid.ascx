<%@ Control Language="C#" AutoEventWireup="true" Inherits="Mediachase.Ibn.Web.UI.Controls.Util.CustomColumnBaseType" ClassName="Mediachase.UI.Web.Apps.MetaUI.Primitives.MenuActions.Grid" %>
