<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SelectItem.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.Apps.MetaUI.Modules.SelectControls.SelectItem" %>
		...
		<td class="ibn-light ibn-separator">
			<table cellspacing="0" cellpadding="0" width="100%" border="0" style="padding:5px"><tr><td>
				<table class="ibn-propertysheet" width="100%" border="0" cellpadding="5" cellspacing="0">
					<tr>
						<td style="width:70px;" class="ibn-label">
							<asp:Literal ID="Literal1" runat="server" Text="<%$Resources: IbnFramework.GlobalMetaInfo, Type %>"></asp:Literal>:
						</td>
						<td class="ibn-value">
						...
						<td class="ibn-value" align="right" >
							...
							<asp:Button runat="server" ID="btnSearch" Text="<%$Resources: IbnFramework.GlobalMetaInfo, Search %>" />
						</td>
					</tr>
				</table>
			</td></tr></table>
		...
		<td>
			<asp:DataGrid runat="server" ID="grdMain" AutoGenerateColumns="false" Width="100%" 
				...
				<Columns>
					...
					<asp:TemplateColumn HeaderText="<%$Resources: IbnFramework.GlobalMetaInfo, Item %>" SortExpression="Name" >
					...
					<asp:TemplateColumn>
						...
						<ItemTemplate>
							<asp:ImageButton id="ibRelate" runat="server" imageurl="~/Images/IbnFramework/relate.gif" ToolTip="<%$Resources: IbnFramework.GlobalMetaInfo, Select %>" Width="16" Height="16"></asp:ImageButton>
						</ItemTemplate>
					</asp:TemplateColumn>
				</Columns>
			</asp:DataGrid>
