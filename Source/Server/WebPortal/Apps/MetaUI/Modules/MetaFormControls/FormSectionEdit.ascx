<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FormSectionEdit.ascx.cs" 
	Inherits="Mediachase.Ibn.Web.UI.MetaUI.FormSectionEdit" %>
<style type="text/css">
  html, body {
   margin: 0;
   height: 100%;
...
<div style="padding:15px;border-bottom:1px solid #adadad" class="ibn-light text">
  <b><asp:Literal ID="Literal1" runat="server" Text='<%$Resources : IbnFramework.MetaForm, Title %>' />:</b>&nbsp;&nbsp;
...
<div id="divControl" runat="server" style="padding:15px;border-bottom:1px solid #adadad" class="ibn-light text">
  <b><asp:Literal ID="Literal2" runat="server" Text='<%$Resources : IbnFramework.MetaForm, Control %>' />:</b>&nbsp;&nbsp;
