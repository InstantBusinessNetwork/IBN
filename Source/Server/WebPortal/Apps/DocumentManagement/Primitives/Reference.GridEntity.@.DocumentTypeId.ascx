<%@ Control Language="C#" AutoEventWireup="true" Inherits="Mediachase.Ibn.Web.UI.Controls.Util.BaseEntityType" ClassName="Mediachase.Ibn.Web.UI.DocumentManagement.Primitives.Reference_GridEntity_Any_DocumentTypeId" %>
