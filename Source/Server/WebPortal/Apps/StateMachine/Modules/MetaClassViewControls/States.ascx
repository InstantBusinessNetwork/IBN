<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="States.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.StateMachine.Modules.MetaClassViewControls.States" %>
<br />
<table width="100%">
	<tr>
		<td class="section"><asp:Literal ID="Literal1" Text="<%$Resources : IbnFramework.GlobalMetaInfo, StateList%>" runat="server"></asp:Literal></td>
