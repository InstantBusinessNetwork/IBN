...
<table cellpadding="3" cellspacing="1" border="0" width="100%" class="ibn-propertysheet">
	<tr>
		...
		<asp:Literal ID="Literal2" runat="server" Text="<%$Resources : IbnFramework.GlobalFieldManageControls, Target%>" />:
		</td>
		<td>
	...
	<tr>
		<td class="ibn-label" width="120px">
		<asp:Literal ID="Literal1" runat="server" Text="<%$Resources : IbnFramework.GlobalFieldManageControls, MaximumLength%>" />:
		</td>
		<td>
	...
	<tr>
		<td></td>
		<td>
			<asp:CheckBox runat="server" ID="chkUnique" Text="<%$Resources : IbnFramework.GlobalFieldManageControls, UniqueValue%>" Checked="false" />
		</td>
	</tr>
</table>