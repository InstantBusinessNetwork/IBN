<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IntegerPercent.Manage.ascx.cs" Inherits="Mediachase.UI.Web.Apps.MetaDataBase.Primitives.IntegerPercent_Manage" %>
