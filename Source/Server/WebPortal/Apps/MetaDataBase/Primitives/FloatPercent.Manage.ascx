<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FloatPercent.Manage.ascx.cs" Inherits="Mediachase.UI.Web.Apps.MetaDataBase.Primitives.FloatPercent_Manage" %>
