<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Image.Manage.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.MetaDataBase.Primitives.Image_Manage" %>
<table cellpadding="3" cellspacing="1" border="0" width="100%" class="ibn-propertysheet">
	...
	<tr>
		<td class="ibn-label" width="120px">
		<asp:Literal ID="Literal2" runat="server" Text="<%$Resources : IbnFramework.GlobalFieldManageControls, Width%>" />:
		</td>
		<td>
	...
	<tr>
		<td class="ibn-label" width="120px">
		<asp:Literal ID="Literal3" runat="server" Text="<%$Resources : IbnFramework.GlobalFieldManageControls, Height%>" />:
		</td>
		<td>
	...
	<tr>
		...
		<td>
			<asp:CheckBox runat="server" ID="chkShowBorder" Text="<%$Resources : IbnFramework.GlobalFieldManageControls, ShowBorder%>" Checked="true" />
		</td>
		<td></td>
	</tr>
</table>