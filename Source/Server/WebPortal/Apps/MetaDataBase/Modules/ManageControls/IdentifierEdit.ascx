<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IdentifierEdit.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.Apps.MetaDataBase.Modules.ManageControls.IdentifierEdit" %>
				...
				<tr>
					<td valign="top" width="50%">
						<table cellpadding="3" cellspacing="1" border="0" width="100%" class="ibn-propertysheet" style="table-layout:fixed">
							...
							<tr>
								<td class="ibn-label"><asp:Literal ID="Literal2" runat="server" Text="<%$Resources : IbnFramework.GlobalMetaInfo, IdentifierName%>" />:</td>
								<td>
							...
							<tr>
								<td class="ibn-label"><asp:Literal ID="Literal3" runat="server" Text="<%$Resources : IbnFramework.GlobalMetaInfo, FriendlyName%>" />:</td>
								<td>
						...
						<table cellpadding="3" cellspacing="1" border="0" width="100%" class="ibn-propertysheet">
							<tr>
								<td class="ibn-label" width="120px">
									<asp:Literal ID="Literal1" runat="server" Text="<%$Resources : IbnFramework.GlobalMetaInfo, IdentifierScope%>" />:
								</td>
								<td>
							...
							<tr>
								<td class="ibn-label" width="120px">
									<asp:Literal ID="Literal4" runat="server" Text="<%$Resources : IbnFramework.GlobalMetaInfo, CounterReset%>" />:
								</td>
								<td>
							...
							<tr>
								<td class="ibn-label" width="120px">
									<asp:Literal ID="Literal5" runat="server" Text="<%$Resources : IbnFramework.GlobalMetaInfo, IdentifierMask%>" />:
								</td>
								<td>
									<asp:TextBox Runat="server" ID="txtMask" Width="100%" MaxLength="50" Text="#" ToolTip="<%$Resources : IbnFramework.GlobalMetaInfo, MaskTooltip%>"></asp:TextBox>
								</td>
								<td width="20px">
							...
							<tr>
								<td class="ibn-label" width="120px">
									<asp:Literal ID="Literal6" runat="server" Text="<%$Resources : IbnFramework.GlobalMetaInfo, CounterLength%>" />:
								</td>
								<td>
...
<table border="0" cellpadding="0" cellspacing="0" width="95%">
	<tr>
		<td align="right" style="padding-top:5px">
			<btn:IMButton runat="server" class="text" style="width:80px" ID="imbtnSave" Text="<%$Resources : IbnFramework.GlobalMetaInfo, Save%>"></btn:IMButton>&nbsp;&nbsp;
			<btn:IMButton runat="server" class="text" style="width:80px" ID="imbtnCancel" Text="<%$Resources : IbnFramework.GlobalMetaInfo, Cancel%>" CausesValidation="false"></btn:IMButton>
		</td>
	</tr>
</table>