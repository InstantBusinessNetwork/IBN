<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MultiReferenceTypeEdit.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.Apps.MetaDataBase.Modules.ManageControls.MultiReferenceTypeEdit" %>
						...
						<asp:DataGrid id="dgClasses" Runat="server" AutoGenerateColumns="False" AllowSorting="False"
							...
							<Columns>
								...
								<asp:TemplateColumn>
									...
									<ItemTemplate>
										<asp:imagebutton id="ibMove" title='Edit' runat="server" borderwidth="0" imageurl="~/images/IbnFramework/edit.gif" commandname="Edit" causesvalidation="False">
										</asp:imagebutton>
										&nbsp;
										<asp:imagebutton id="ibDelete" title='Delete' runat="server" borderwidth="0" imageurl="~/images/IbnFramework/delete.gif" commandname="Delete" causesvalidation="False">
										</asp:imagebutton>
									</ItemTemplate>
									<EditItemTemplate>
										<asp:imagebutton id="Imagebutton1" title='Save' runat="server" borderwidth="0" imageurl="~/images/IbnFramework/Saveitem.gif" commandname="Update" causesvalidation="False">
										</asp:imagebutton>
										&nbsp;
										<asp:imagebutton id="Imagebutton2" title='Cancel' runat="server" borderwidth="0" imageurl="~/images/IbnFramework/cancel.gif" commandname="Cancel" causesvalidation="False">
										</asp:imagebutton>
									</EditItemTemplate>
								</asp:TemplateColumn>
							</Columns>
