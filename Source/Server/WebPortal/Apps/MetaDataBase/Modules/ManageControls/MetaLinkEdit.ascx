<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MetaLinkEdit.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.Apps.MetaDataBase.Modules.ManageControls.MetaLinkEdit" %>
								  ...
								  <Columns>
									...
									<asp:TemplateField>
										<ItemStyle CssClass="ibn-vb" Width="26px" />
										  ...
										  <ItemTemplate>
											  <asp:ImageButton ImageUrl="~/Images/IbnFramework/delete.gif" Runat=server ToolTip="Delete" Width=16 Height=16 CommandName="Delete" CommandArgument='<%# Eval("Name") %>' ID="ibDelete"></asp:ImageButton> 
										  </ItemTemplate>
									  </asp:TemplateField>
...
<div style="padding: 10 10 0 0; text-align:right">
	<mc:IMButton runat="server" class="text" style="width:110px" Text="<%$Resources : IbnFramework.GlobalMetaInfo, Save%>" ID="imbtnSave"></mc:IMButton>
	<mc:IMButton runat="server" class="text" style="width:110px" ID="imbtnCancel" Text="<%$Resources : IbnFramework.GlobalMetaInfo, Cancel%>" CausesValidation="false"></mc:IMButton>
</div>