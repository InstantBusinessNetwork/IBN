<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MultiReferenceTypeList.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.Apps.MetaDataBase.Modules.ManageControls.MultiReferenceTypeList" %>
