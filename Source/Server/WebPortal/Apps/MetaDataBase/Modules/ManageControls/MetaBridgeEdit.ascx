<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MetaBridgeEdit.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.Apps.MetaDataBase.Modules.ManageControls.MetaBridgeEdit" %>
					...
					<td width="50%" valign="top">
						<fieldset>
							...
							<table cellpadding="5" cellspacing="1" border="0" class="ibn-propertysheet" width="100%">
								<tr>
									<td class="ibn-label" width="120px">
										<asp:Literal ID="Literal4" runat="server" Text="<%$Resources : IbnFramework.GlobalMetaInfo, Table%>" />:
									</td>
									<td>
						...
						<fieldset style="margin-top:5px;">
							...
							<table cellpadding="5" cellspacing="1" border="0" class="ibn-propertysheet" width="100%">
								<tr>
									<td class="ibn-label" width="120px">
										<asp:Literal ID="Literal7" runat="server" Text="<%$Resources : IbnFramework.GlobalMetaInfo, Table%>" />:
									</td>
									<td>
								...
								<tr>
									<td class="ibn-label" width="120px">
										<asp:Literal ID="Literal8" runat="server" Text="<%$Resources : IbnFramework.GlobalMetaInfo, SystemName%>" />:
									</td>
									<td>
								...
								<tr>
									<td class="ibn-label" width="120px">
										<asp:Literal ID="Literal9" runat="server" Text="<%$Resources : IbnFramework.GlobalMetaInfo, FriendlyName%>" />:
									</td>
									<td>
