<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MultiReferenceTypeView.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.Apps.MetaDataBase.Modules.ManageControls.MultiReferenceTypeView" %>
				...
				<table class="ibn-propertysheet" width="100%" border="0" cellpadding="5" cellspacing="0">
					<tr>
						<td class="ibn-label" align="right" style="width:200px;">
							<asp:Literal ID="Literal9" runat="server" Text="<%$Resources : IbnFramework.GlobalMetaInfo, SystemName%>" />:
						</td>
						<td class="ibn-value">
							<asp:Label runat="server" ID="lblSystemName"></asp:Label>
						</td>
						<td class="ibn-label" align="right" valign="top">
							<asp:Literal ID="Literal2" runat="server" Text="<%$Resources : IbnFramework.GlobalMetaInfo, MReferenceMetaClasses%>" />:
						</td>
					...
					<tr>
						<td class="ibn-label" align="right">
							<asp:Literal ID="Literal1" runat="server" Text="<%$Resources : IbnFramework.GlobalMetaInfo, FriendlyName%>" />:
						</td>
						<td class="ibn-value">
