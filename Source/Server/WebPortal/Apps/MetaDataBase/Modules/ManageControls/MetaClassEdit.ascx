<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MetaClassEdit.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.Apps.MetaDataBase.Modules.ManageControls.MetaClassEdit" %>
					...
					<td width="50%" valign="top">
						<fieldset style="margin:0px;padding:2px;width:100%;">
							...
							<table cellpadding="5" cellspacing="0" border="0" class="ibn-propertysheet" width="100%">
								...
								<tr>
									<td class="ibn-label" width="120px">
										<asp:Literal ID="Literal3" runat="server" Text="<%$Resources : IbnFramework.GlobalMetaInfo, PluralName%>" />:
									</td>
									<td>
								...
								<tr>
									<td width="120px"></td>
									<td>
										<asp:CheckBox Runat="server" ID="chkSupportsCards" Checked="False" Text="<%$Resources : IbnFramework.GlobalMetaInfo, SupportsCards%>"></asp:CheckBox>
									</td>
									<td></td>
									<td></td>
								</tr>
					...
					<td width="50%" valign="top">
						<fieldset style="margin:0;padding:2px;width:100%">
							...
							<table cellpadding="3" cellspacing="1" border="0" class="ibn-propertysheet" width="100%">
								<tr>
									<td class="ibn-label" width="120px">
										<asp:Literal ID="Literal5" runat="server" Text="<%$Resources : IbnFramework.GlobalMetaInfo, SystemName%>" />:
									</td>
									<td>
								...
								<tr>
									<td class="ibn-label" width="120px">
										<asp:Literal ID="Literal6" runat="server" Text="<%$Resources : IbnFramework.GlobalMetaInfo, FriendlyName%>" />:
									</td>
									<td>
								...
								<tr id="trMaxLen">
									<td class="ibn-label" width="120px">
										<asp:Literal ID="Literal7" runat="server" Text="<%$Resources : IbnFramework.GlobalMetaInfo, MaximumLength%>" />:
									</td>
									<td>
...
<div style="padding: 10 10 0 0; text-align:right">
	<btn:IMButton runat="server" ID="btnSave" Text="<%$Resources : IbnFramework.GlobalMetaInfo, Save%>" class="text" style="width:110px" ></btn:IMButton>&nbsp;&nbsp;
	<btn:IMButton runat="server" ID="btnCancel" Text="<%$Resources : IbnFramework.GlobalMetaInfo, Cancel%>" CausesValidation="false" class="text" style="width:110px"></btn:IMButton>
</div>