<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TriggerEdit.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.Apps.MetaDataBase.Modules.ManageControls.TriggerEdit" %>
		...
		<td style="padding:10px;">
			...
			<ContentTemplate>
				<table cellpadding="3" cellspacing="0" border="0" width="100%" class="ibn-propertysheet" style="table-layout:fixed">
					...
					<tr>
						<td valign="top">
							<asp:Literal ID="Literal6" Text="<%$Resources : IbnFramework.GlobalMetaInfo, Description%>" runat="server"></asp:Literal>:
						</td>
						<td>
					...
					<tr>
						<td>
							<asp:Literal ID="Literal7" Text="<%$Resources : IbnFramework.GlobalMetaInfo, Operation%>" runat="server"></asp:Literal>:
						</td>
						<td>
					...
					<tr>
						<td>
							<asp:Literal ID="Literal2" Text="<%$Resources : IbnFramework.GlobalMetaInfo, TriggerCondition%>" runat="server"></asp:Literal>:
						</td>
						<td>
				...
				<div style="padding-top:5px; padding-left:3px;">
					<asp:Literal ID="Literal4" Text="<%$Resources : IbnFramework.GlobalMetaInfo, Parameters%>" runat="server"></asp:Literal>:
				</div>
				...
				<table cellpadding="3" cellspacing="0" border="0" width="100%" class="ibn-propertysheet" style="table-layout:fixed">
					<tr>
						<td style='width:<%= labelColumnWidth%>'>
							<asp:Literal ID="Literal3" Text="<%$Resources : IbnFramework.GlobalMetaInfo, TriggerAction%>" runat="server"></asp:Literal>:
						</td>
						<td>
				...
				<div style="padding-top:5px; padding-left:3px;">
					<asp:Literal ID="Literal5" Text="<%$Resources : IbnFramework.GlobalMetaInfo, Parameters%>" runat="server"></asp:Literal>:
				</div>
			...
			<div style="padding-top:10px; text-align:center;">
				...
				<asp:Button runat="server" ID="btnCancel" Text="<%$Resources : IbnFramework.Global, _mc_Cancel%>" OnClientClick="window.close();return false;" Width="80" style="margin-left:15px;" CausesValidation="false" />
			</div>
		</td>
	</tr>
</table>