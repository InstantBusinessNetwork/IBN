<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QuickAdd.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.TimeTracking.Modules.PublicControls.QuickAdd" %>
	...
	<tr>
		<td>
			<table cellspacing="5" cellpadding="0" width="100%" class="ibn-propertysheet" border="0" style="table-layout:fixed;">
				<tr>
					<td style="width: 185px;"><asp:Literal runat="server" ID="Literal1" Text="<%$Resources : IbnFramework.TimeTracking, _mc_SelectProject%>"></asp:Literal>:</td>
					<td>
						...
						<lst:IndentedDropDownList ID="ProjectList" Width="270px" runat="server"></lst:IndentedDropDownList>
						<asp:Label ID="lblError2" runat="server" CssClass="text" ForeColor="Red" Text="*"></asp:Label>
					</td>
				</tr>
				<tr>
					<td valign="top">
						<asp:Literal runat="server" ID="Literal2" Text="<%$Resources : IbnFramework.TimeTracking, _mc_WorkDescription%>"></asp:Literal>:
					</td>
					<td valign="top">
						<span class="ffBugFix">
						<asp:TextBox ID="txtEntry" runat="server" Width="270px" Text=""></asp:TextBox>
				...
				<tr>
					<td colspan="2" align="center" style="padding-top:10px;">
						...
						<asp:Button ID="CancelButton" runat="server" OnClick="CancelButton_Click" Text="<%$Resources : IbnFramework.TimeTracking, _mc_Close%>" Width="100px" CausesValidation="false" />	
					</td>
				</tr>
			</table>
		</td>
