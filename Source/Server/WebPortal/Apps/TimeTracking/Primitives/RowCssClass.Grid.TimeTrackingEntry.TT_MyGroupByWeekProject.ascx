<%@ Control Language="C#" AutoEventWireup="true" ClassName="Mediachase.Ibn.Web.UI.TimeTracking.Primitives.RowCssClass_Grid_TimeTrackingEntry_TT_MyGroupByWeekProject" Inherits="Mediachase.Ibn.Web.UI.Controls.Util.BaseType" %>
