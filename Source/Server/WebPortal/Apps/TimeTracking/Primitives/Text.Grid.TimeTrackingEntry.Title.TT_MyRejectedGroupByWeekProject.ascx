<%@ Control Language="C#" AutoEventWireup="true" ClassName="Mediachase.Ibn.Web.UI.TimeTracking.Primitives.Text_Grid_TimeTrackingEntry_Title_TT_MyRejectedGroupByWeekProject" Inherits="Mediachase.Ibn.Web.UI.Controls.Util.BaseType" %>
