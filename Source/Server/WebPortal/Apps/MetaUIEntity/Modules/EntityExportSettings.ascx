<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EntityExportSettings.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.MetaUIEntity.Modules.EntityExportSettings" %>
<style type="text/css">
	.pad5 tbody tr td
	{
		padding: 5px;
