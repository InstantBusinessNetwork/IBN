	...
	<Columns>
		...
		<asp:TemplateColumn>
			<ItemTemplate>
				...
				<asp:ImageButton ImageUrl="~/Images/IbnFramework/delete.gif" Runat="server" ToolTip="<%$Resources : IbnFramework.GlobalMetaInfo, Delete%>" Width="16" Height="16" CommandName='<%# ConstDeleteCommand %>' CommandArgument='<%# Eval("Id") %>' ID="ibDelete" Visible='<%# Eval("CanDelete")%>'></asp:ImageButton>
				<asp:ImageButton ImageUrl="~/Images/IbnFramework/Undo.png" Runat="server" ToolTip="<%$Resources : IbnFramework.GlobalMetaInfo, ResetToDefault%>" Width="16" Height="16" CommandName='<%# ConstResetCommand %>' CommandArgument='<%# Eval("Id") %>' ID="ibReset" Visible='<%# Eval("CanReset")%>'></asp:ImageButton>
			</ItemTemplate>
