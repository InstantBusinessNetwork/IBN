...
<table width="250px" cellpadding="0" cellspacing="0" border="0" class="ibn-propertysheet" style="table-layout:fixed" runat="server" id="tblMain">
	<tr>
		<td id="tdValue" runat="server"><div class="dropstyle" style="white-space:nowrap"><asp:Label runat="server" ID="lblSelected"></asp:Label></div></td>
		<td class="btndown" id="tdChange" runat="server" style="width:14px;"><asp:Label ID="lblChange" Runat="server"></asp:Label></td>
	</tr>
</table>
