		...
		<td>
			<table cellspacing="0" cellpadding="0" border="0" style="border-width:0px;width:100%;border-collapse:collapse;margin-top:5px;">
				<tr>
					...
					<td id="tdTab3" runat="server" class="ibn-navframe tab" style="width:120px;white-space:nowrap;width:120px;">
						<nobr>&nbsp;<a id="aTab3" class='tabTLink' href="javascript:ChangeTab('Panel3');"><%=GetGlobalResourceObject("IbnFramework.Global", "GeneralTab").ToString()%></a>&nbsp;</nobr>
					</td>
					<td class="ibn-stylebox tabGap">&nbsp;</td>
					<td id="tdTab1" runat="server" class="ibn-navframe tab" style="width:120px;white-space:nowrap;width:120px;">
						<nobr>&nbsp;<a id="aTab1" class='tabTLink' href="javascript:ChangeTab('Panel1');"><%=GetGlobalResourceObject("IbnFramework.Global", "FieldsTab").ToString()%></a>&nbsp;</nobr>
					</td>
					<td class="ibn-stylebox tabGap" id="tab4Gap" runat="server">&nbsp;</td>
					<td id="tdTab4" runat="server" class="ibn-navframe tab" style="width:120px;white-space:nowrap;width:120px;">
						<nobr>&nbsp;<a id="a4" class='tabTLink' href="javascript:ChangeTab('Panel4');"><%=GetGlobalResourceObject("IbnFramework.Global", "GroupsTab").ToString()%></a>&nbsp;</nobr>
					</td>
					<td class="ibn-stylebox tabGap" id="tab2Gap" runat="server">&nbsp;</td>
					<td id="tdTab2" runat="server" class="ibn-navframe tab" style="width:120px;white-space:nowrap;width:120px;">
						<nobr>&nbsp;<a id="aTab2" class='tabTLink' href="javascript:ChangeTab('Panel2');"><%=GetGlobalResourceObject("IbnFramework.Global", "FiltersTab").ToString()%></a>&nbsp;</nobr>
					</td>
					<td class="ibn-stylebox tabGap">&nbsp;</td>
			...
			<td valign="top" align="center">
				<div style="padding-top:15px;">
					...
					<table border="0" class="tablePadding3">
						<tr>
							<td style="width: 250px"><asp:Literal ID="Literal1" runat="server" Text='<%$Resources : IbnFramework.GlobalMetaInfo, AvailableColumns %>' />:</td>
							<td style="width: 25px"></td>
							<td style="width: 250px"><asp:Literal ID="Literal2" runat="server" Text='<%$Resources : IbnFramework.GlobalMetaInfo, VisibleColumns %>' />:</td>
							<td style="width: 25px"></td>		
						</tr>
						<tr>
							...
							<td>
								<asp:Button runat="server" ID="btnUp" text="↑"  OnClientClick="return false;" /> <br /><br />
								<asp:Button runat="server" ID="btnDown" text="↓" OnClientClick="return false;" />
							</td>
						</tr>
					</table>
				</div>
				...
				<div style="width:70%;padding-top:15px;">
					...
					<table width="100%" class="ibn-stylebox-light padTable5">
						<tr>
							...
							<td class="text" style="PADDING-RIGHT: 15px" valign="top"><asp:Literal ID="Literal3" runat="server" Text="<%$Resources: IbnFramework.Global, NewViewGeneralTabComment%>" /></td>
						</tr>
					</table>
				</div>
			</td>
