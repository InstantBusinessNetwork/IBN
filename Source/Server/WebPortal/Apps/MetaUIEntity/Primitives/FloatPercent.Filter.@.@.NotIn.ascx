<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FloatPercent.Filter.@.@.NotIn.ascx.cs" Inherits="Mediachase.UI.Web.Apps.MetaUIEntity.Primitives.FloatPercent_Filter__NotIn" %>
