<%@ Control Language="C#" AutoEventWireup="true" Inherits="Mediachase.Ibn.Web.UI.Controls.Util.CustomColumnBaseEntityType" ClassName="Mediachase.UI.Web.Apps.MetaUI.EntityPrimitives.MenuActions_GridEntity" %>
...
<script language="c#" runat="server">
	...
	void BindAction(EntityObject DataItem)
	{
		...
		IXPathNavigable navigable = Mediachase.Ibn.XmlTools.XmlBuilder.GetXml(StructureType.ListViewUI, new Selector(DataItem.MetaClassName, this.ViewName, this.Place));
