<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IntegerPercent.Filter.@.@.NotIn.ascx.cs" Inherits="Mediachase.UI.Web.Apps.MetaUIEntity.Primitives.IntegerPercent_Filter__NotIn" %>
