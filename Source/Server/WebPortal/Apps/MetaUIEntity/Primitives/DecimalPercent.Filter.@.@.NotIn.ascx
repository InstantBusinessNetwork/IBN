<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DecimalPercent.Filter.@.@.NotIn.ascx.cs" Inherits="Mediachase.UI.Web.Apps.MetaUIEntity.Primitives.DecimalPercent_Filter__NotIn" %>
