<%@ Control Language="C#" AutoEventWireup="true" ClassName="Mediachase.Ibn.Web.UI.MetaUI.EntityPrimitives.Url_ViewEntity" Inherits="Mediachase.Ibn.Web.UI.Controls.Util.BaseEntityType" %>
