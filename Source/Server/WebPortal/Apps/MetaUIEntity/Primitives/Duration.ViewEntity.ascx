<%@ Control Language="C#" AutoEventWireup="true" ClassName="Mediachase.UI.Web.Apps.MetaUI.EntityPrimitives.Duration_ViewEntity" Inherits="Mediachase.Ibn.Web.UI.Controls.Util.BaseEntityType" %>
