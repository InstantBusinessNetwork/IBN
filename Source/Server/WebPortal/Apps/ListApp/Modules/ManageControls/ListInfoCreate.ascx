<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ListInfoCreate.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.ListApp.Modules.ManageControls.ListInfoCreate" %>
			...
			<table cellpadding="7" cellspacing="0" width="100%" border="0">
				...
				<tr>
					<td style="padding: 0px;"; colspan="2">
						<asp:UpdatePanel ID="upTemplate" runat="server">
							<ContentTemplate>
								<table cellpadding="7" cellspacing="0" width="100%" border="0">
									<tr>
										<td class="ibn-label" style="width:120px;"><asp:Literal ID="Literal1" runat="server" Text="<%$Resources : IbnFramework.ListInfo, tTemplate%>" />:</td>
										<td><asp:DropDownList AutoPostBack="true" ID="ddTemplates" Width="99%" runat="server" OnSelectedIndexChanged="ddTemplates_SelectedIndexChanged"></asp:DropDownList></td>
									</tr>
									<tr id="trWithData" runat="server">
										<td></td>
										<td><asp:CheckBox ID="cbWithData" runat="server" /></td>
									</tr>
								</table>
							</ContentTemplate>
						</asp:UpdatePanel>
