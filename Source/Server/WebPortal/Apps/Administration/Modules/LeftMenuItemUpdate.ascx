<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LeftMenuItemUpdate.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.Administration.Modules.LeftMenuItemUpdate" %>
