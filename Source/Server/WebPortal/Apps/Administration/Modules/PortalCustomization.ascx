<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PortalCustomization.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.Administration.Modules.PortalCustomization" %>
	...
	<tr>
		<td valign="top">
			<div id="mainDiv" style="overflow: auto;">
				<div>
					<ibn:XmlFormBuilder ID="xmlStruct" runat="server" LayoutMode="WithTabs" PlaceName="PortalCustomization"
						LayoutType="Custom" />
				</div>
			</div>
		</td>
