<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LeftMenuItemAdd.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.Administration.Modules.LeftMenuItemAdd" %>
	...
	<tr>
		...
		<td valign="top" style="padding-right:8px; padding-left:8px;">
			<table cellpadding="0" cellspacing="3" width="100%" id="DataTable" style="table-layout: fixed;">
				...
				<tr>
					<td class="ibn-label">
						<asp:Literal ID="Literal4" runat="server" Text="<%$ Resources: IbnFramework.GlobalMetaInfo, MenuItemLink %>"></asp:Literal>:
					</td>
					<td>
