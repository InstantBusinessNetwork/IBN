...
namespace Mediachase.Ibn.Web.UI.Apps.WidgetEngine.Extender
{
	...
	public class WsLayoutExtender : ExtenderControl
	{
		...
		/// </summary>
		/// <value><c>true</c> if this instance is admin; otherwise, <c>false</c>.</value>
		public LayoutContextKey ContextKey
		{
			get
			{
				if (this.ViewState["__ContextKey"] != null)
					return (LayoutContextKey)this.ViewState["__ContextKey"];

				return null;
			}
			set
			{
				this.ViewState["__ContextKey"] = value;
			}
		}
		#endregion
		...
		protected override IEnumerable<ScriptReference> GetScriptReferences()
		{
			...
			reference.Path = McScriptLoader.Current.GetScriptUrl("~/Scripts/IbnFramework/WsLayoutExtender.js", this.Page);
