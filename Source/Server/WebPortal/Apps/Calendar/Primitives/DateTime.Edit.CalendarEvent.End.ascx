<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DateTime.Edit.CalendarEvent.End.ascx.cs" Inherits="Mediachase.Ibn.Web.UI.Calendar.Primitives.DateTime_Edit_CalendarEvent_End" %>
