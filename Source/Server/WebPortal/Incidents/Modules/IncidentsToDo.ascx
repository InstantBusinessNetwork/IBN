...
<%@ Control Language="c#" Inherits="Mediachase.UI.Web.Incidents.Modules.IncidentsToDo" Codebehind="IncidentsToDo.ascx.cs" %>
...
<table cellspacing="0" cellpadding="0" width="100%" border="0" style="margin-top:5px">
	...
	<tr>
		<td>
			<table cellspacing="0" cellpadding="0" width="100%" border="0" class="ibn-stylebox-light">
				<tr>
					<td style="padding:5px;">
						<dg:datagridextended id="dgToDo" runat="server" width="100%" autogeneratecolumns="False" borderwidth="0px" CellSpacing="0" gridlines="None" cellpadding="2" allowsorting="True" allowpaging="False" ShowHeader="True">
