<%@ Page Language="c#" Inherits="Mediachase.UI.Web.Incidents.ResourcesEditor" CodeBehind="ResourcesEditor.aspx.cs" %>
...
<head runat="server">
	...
	<title><%=LocRM.GetString("tIssueTitle")%></title>
...
<body class="UserBackground">
				...
				<div style='overflow-y: auto; height: <%=Request.Browser.Browser.IndexOf("IE")>=0 ? "295" : "305" %>px'>
					<asp:DataGrid runat="server" ID="dgMembers" AutoGenerateColumns="False" AllowPaging="False" AllowSorting="False" CellPadding="1" GridLines="None" CellSpacing="1" BorderWidth="0px" Width="100%">
						...
						<Columns>
							...
							<asp:TemplateColumn Visible="True" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="20px" HeaderStyle-Width="20px">
								<ItemTemplate>
	...
	<script type="text/javascript">
		...
		function FuncCancel(IncidentId)
		{
			...
			if(obj!=null)
				...
				window.top.frames['right'].location.href='IncidentView.aspx?IncidentId='+IncidentId;
		}
		//]]>
	</script>
