...
<%@ Control Language="c#" Inherits="Mediachase.UI.Web.Admin.Modules.EMailBlackList" Codebehind="EMailBlackList.ascx.cs" %>
...
<table class="ibn-stylebox text" style="MARGIN-TOP: 0px" cellspacing="0" cellpadding="0" width="100%" border="0">
	<tr>
		<td><ibn:blockheader id="secHeader" title="Black List" runat="server"></ibn:blockheader></td>
	</tr>
	<tr>
		<td>
	...
	<tr>
		<td>
			<dg:DataGridExtended id="dgBlackList" runat="server" allowpaging="True" 
