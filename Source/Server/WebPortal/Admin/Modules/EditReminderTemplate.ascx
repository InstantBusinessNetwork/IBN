...
<%@ Control Language="c#" Inherits="Mediachase.UI.Web.Admin.Modules.EditReminderTemplate" Codebehind="EditReminderTemplate.ascx.cs" %>
		...
		<td>
			...
			<table cellspacing="3" cellpadding="3" width="100%" align="right" border="0">
				<tr>
					...
					<td align="right"><btn:ImButton ID="btnCancel" CausesValidation="false" Runat="server" Class="text" IsDecline="true" style="width:110px;" onserverclick="btnCancel_Click"></btn:ImButton>
					</td>
					<td width="6"><img src='<%= ResolveClientUrl("~/layouts/images/blank.gif") %>' width="6" height="1" alt=""></td>
