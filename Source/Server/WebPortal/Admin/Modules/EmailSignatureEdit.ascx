...
<%@ Control Language="c#" Inherits="Mediachase.UI.Web.Admin.Modules.EmailSignatureEdit" Codebehind="EmailSignatureEdit.ascx.cs" %>
		...
		<td>
			<table class="text" cellspacing="3" cellpadding="3" width="100%" border="0">
				...
				<tr>
					...
					<td valign="top">
						<asp:TextBox Runat="server" ID="tbSubject" Width="100%" ></asp:TextBox>
					</td>
				</tr>
				<tr>
