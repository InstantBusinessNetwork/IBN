<%@ Page Language="c#" Inherits="Mediachase.UI.Web.Projects.StakeholdersEditor" CodeBehind="StakeholdersEditor.aspx.cs" %>
			...
			<td valign="top" width="280">
				...
				<table class="text" style="margin-top: 5px" cellspacing="0" cellpadding="3" width="100%">
					...
					<tr>
						...
						<td>
							<asp:TextBox ID="tbSearch" runat="server" CssClass="text" Width="125px">
							</asp:TextBox><asp:Button ID="btnSearch" runat="server" Width="60px" CssClass="text" CausesValidation="False" OnClick="btnSearch_Click"></asp:Button><asp:Label ID="lblError" CssClass="ibn-error" runat="server"></asp:Label>
						</td>
					</tr>
					<tr>
