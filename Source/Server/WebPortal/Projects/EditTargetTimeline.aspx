<%@ Page Language="c#" Inherits="Mediachase.UI.Web.Projects.EditTargetTimeline" CodeBehind="EditTargetTimeline.aspx.cs" %>
	...
	<table class="text" cellspacing="0" cellpadding="7" width="100%" border="0">
		<tr>
			<td width="150" align="right">
				<b>
					<%= LocRM.GetString("target_start_date")%>:</b>
			</td>
			<td class="ibn-value">
				<mc:Picker ID="dtcTargetStartDate" runat="server" DateCssClass="text" DateWidth="85px" ShowImageButton="false" DateIsRequired="true" />
			</td>
		</tr>
		<tr>
			<td width="150" align="right">
				<b>
					<%= LocRM.GetString("target_finish_date")%>:</b>
			</td>
			<td class="ibn-value">
				<mc:Picker ID="dtcTargetEndDate" runat="server" DateCssClass="text" DateWidth="85px" ShowImageButton="false" DateIsRequired="true" />
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2" align="center">
				<btn:IMButton class="text" ID="btnSave" runat="server" style="width: 120px;">
				</btn:IMButton>
				<br/>
				<br/>
