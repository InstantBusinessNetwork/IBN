...
{
	/// <summary>
	/// Summary description for strStakeholdersEditor.
	/// </summary>
	public partial class StakeholdersEditor : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			LocRM = new ResourceManager("Mediachase.UI.Web.App_GlobalResources.Projects.Resources.strStakeholdersEditor", typeof(StakeholdersEditor).Assembly);
			ResourceManager LocRM2 = new ResourceManager("Mediachase.UI.Web.App_GlobalResources.Projects.Resources.strTeamEditor", typeof(StakeholdersEditor).Assembly);
		...
		{
			ViewState["Stakeholders"] = Project.GetListStakeholdersDataTable(ProjectID);
		}
		#endregion
		...
		{
			lbUsers.Items.Clear();
			DataTable dt = (DataTable)ViewState["Stakeholders"];
			if (groupId > 0)
			{
		...
		protected void btnSave_Click(object sender, System.EventArgs e)
		{
			...
			ArrayList aStakeholders = new ArrayList();
			foreach (DataRow dr in dt.Rows)
				aStakeholders.Add((int)dr["PrincipalId"]);

			Project2.UpdateStakeholders(ProjectID, aStakeholders);
