...
<%@ Control Language="c#" Inherits="Mediachase.UI.Web.Projects.Modules.LatestAllUpdates" Codebehind="LatestAllUpdates.ascx.cs" %>
					...
					<Columns>
						...
						<ItemTemplate>
								<%# Mediachase.UI.Web.Util.CommonHelper.GetUserStatus
									(
										(int)DataBinder.Eval(Container.DataItem, "LastEditorId")
									)
								%>
								</a>
							</ItemTemplate>
						</asp:TemplateColumn>
						<asp:BoundColumn DataField="LastSavedDate" ItemStyle-Width="120" DataFormatString="{0:d}"></asp:BoundColumn>
					</Columns>
				</asp:DataGrid>
			</asp:panel>
