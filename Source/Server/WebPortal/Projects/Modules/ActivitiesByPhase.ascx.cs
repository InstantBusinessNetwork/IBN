namespace Mediachase.UI.Web.Projects.Modules
{
	...
	/// <summary>
	///		Summary description for ActivitiesByPhase.
	/// </summary>
	public partial class ActivitiesByPhase : System.Web.UI.UserControl
	{
    protected ResourceManager LocRM = new ResourceManager("Mediachase.UI.Web.App_GlobalResources.Projects.Resources.strProjects", typeof(ActivitiesByPhase).Assembly);
		...
		private void BindDG()
		{
			...
			DataTable dt = Project.GetListProjectsGroupedByPhase(PortfolioId, PhaseId, StatusId);
		...
		protected string GetTitle(bool IsHeader, int PrjId, string PortfolioName, int ProjectsCount)
		{
			if (IsHeader) 
			{
				return "<table class='alt-tblstyle' style='width:100%'><tr><td class='text'>" +
					"<b>" + PortfolioName + "&nbsp;(&nbsp;"+ProjectsCount + "&nbsp)</b>" +
					"</td></tr></table>";
			}
			else
			{
