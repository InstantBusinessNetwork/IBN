<%@ Control Language="c#" Inherits="Mediachase.UI.Web.Projects.Modules.ActivitiesByPrjGroup" Codebehind="ActivitiesByPrjGroup.ascx.cs" %>
					...
					<asp:TemplateColumn>
						...
						<ItemTemplate>
							<%# GetTitle(
								...
								DataBinder.Eval(Container.DataItem,"PortfolioName").ToString(),
