namespace Mediachase.UI.Web.Modules
{
	...
	{
		protected ResourceManager LocRM = new ResourceManager("Mediachase.UI.Web.App_GlobalResources.Modules.Resources.strTemplate", typeof(ReportHeader).Assembly);
		...
		private string reportcreator = Security.CurrentUser.DisplayName;
		...
		private DateTime reportcreated = UserDateTime.UserNow;
