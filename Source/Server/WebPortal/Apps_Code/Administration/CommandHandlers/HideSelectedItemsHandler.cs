...
{
	public class HideSelectedItemsHandler : ICommand
	{
		...
		public void Invoke(object Sender, object Element)
		{
			if (Element is CommandParameters)
			{
				...
				using (DbTransaction tran = DbTransaction.Begin())
				{
					...
					{
						NavigationManager.HideCustomizationItem(fullId, CustomizationStructureType.NavigationMenu, profileId, principalId);
					}
					tran.Commit();
				}
