namespace Mediachase.UI.Web.Common.Modules
{
	...
	/// <summary>
	///		Summary description for LatestVisitors.
	/// </summary>
	public partial class LatestVisitors : System.Web.UI.UserControl, IPageTemplateTitle
	{
		protected ResourceManager LocRM = new ResourceManager("Mediachase.UI.Web.App_GlobalResources.Common.Resources.strPageTitles", typeof(LatestVisitors).Assembly);
		...
		private void BindDG()
		{
			dgMain.DataSource = Common.GetListHistoryByObjectDT(ObjectId, ObjectTypeId);
			dgMain.DataBind();
		}
		...
		{
			return LocRM.GetString("LatestVisitors");
		}
		#endregion
	}
}
