<%@ Page Language="c#" Inherits="Mediachase.UI.Web.Tasks.DeleteTaskModal" CodeBehind="DeleteTaskModal.aspx.cs" %>
...
<body style="padding-right: 10px; padding-left: 10px; padding-bottom: 10px; padding-top: 10px">
	...
	<p align="center">
		...
		&nbsp;&nbsp;
		<input type="button" class="text" value='<%#LocRM.GetString("DeleteTask") %>' style="width: 90px" onclick="Task();" />
		&nbsp;&nbsp;
