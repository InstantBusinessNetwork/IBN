...
<%@ Control Language="c#" Inherits="Mediachase.UI.Web.Tasks.Modules.TaskSuccessors" Codebehind="TaskSuccessors.ascx.cs" %>
...
<table cellspacing="0" cellpadding="0" border="0" width="100%" class="ibn-stylebox-light">
	<tr>
		<td>
			<asp:DataGrid Runat="server" ID="dgSuccessors" AutoGenerateColumns="False" AllowPaging="False" AllowSorting="False" cellpadding="3" gridlines="None" CellSpacing="0" borderwidth="0px" Width="100%" ShowHeader="True" CssClass="ibn-propertysheet">
						...
						<EditItemTemplate>
							<table border="0" cellpadding="0" cellspacing="0" class="text">
								<tr>
									...
									<td width="50">
										<asp:TextBox Runat="server" CssClass="text" Width="35" ID="tbH" MaxLength="4" Font-Size="10px"></asp:TextBox><asp:RequiredFieldValidator Runat="server" CssClass="text" ControlToValidate="tbH" Display="Dynamic" ErrorMessage="*" ID="Requiredfieldvalidator1"></asp:RequiredFieldValidator>
