namespace Mediachase.UI.Web.Tasks.Modules
{
	...
	/// <summary>
	///		Summary description for AddSuccessor.
	/// </summary>
	public partial  class AddSuccessor : System.Web.UI.UserControl
	{
		protected ResourceManager LocRM = new ResourceManager("Mediachase.UI.Web.App_GlobalResources.Tasks.Resources.strPredecessors", typeof(AddSuccessor).Assembly);
		...
		private void BindDefaultValues()
		{
			...
			ddGroups.DataSource = Task.GetListVacantSuccessors(TaskID);
			ddGroups.DataBind();
		}
		#endregion
