<%@ Control Language="c#" Inherits="Mediachase.UI.Web.Tasks.Modules.TaskGeneralResources" Codebehind="TaskGeneralResources.ascx.cs" %>
	...
	<tr>
		<td>
			<asp:DataGrid Runat="server" ID="dgMembers" AutoGenerateColumns="False" 
				AllowPaging="False" AllowSorting="False" cellpadding="3" gridlines="None" 
				CellSpacing="3" borderwidth="0px" Width="100%" ShowHeader="true" 
				...
				<Columns>
					...
					<asp:TemplateColumn HeaderText='Can Manage' ItemStyle-Width="60" HeaderStyle-Width="60">
						<ItemTemplate>
							<%# GetManageType( (bool)Eval("CanManage") )%>
						</ItemTemplate>
					</asp:TemplateColumn>
