<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InActivities.ascx.cs" Inherits="Mediachase.UI.Web.Workspace.Modules.InActivities" %>
		...
		<td class="ibn-propertysheet" valign="top">
			...
			<asp:DataGrid id="gridActivities" Runat="server" PagerStyle-Mode="NumericPages" AutoGenerateColumns="False"
				...
				<Columns>
					...
					<asp:TemplateColumn SortExpression="PercentCompleted">
						<HeaderStyle CssClass="ibn-vh2" Width="38px"></HeaderStyle>
						<ItemStyle CssClass="ibn-vb2" Width="38px"></ItemStyle>
						<ItemTemplate><%# Eval("PercentCompleted")%>%</ItemTemplate>
					</asp:TemplateColumn>
					<asp:TemplateColumn SortExpression="PriorityId">
						<HeaderStyle CssClass="ibn-vh2" Width="100"></HeaderStyle>
