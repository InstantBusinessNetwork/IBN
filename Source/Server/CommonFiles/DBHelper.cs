...
namespace Mediachase.Database
{
	...
	public class DBHelper
	{
		...
		#endregion
		#region MakeCommand()
		public static SqlCommand MakeCommand(CommandType type, string cmdText, params SqlParameter[] parameters)
		{
		...
		public DateTime RunCmdDateTime(SqlCommand cmd)
		{
			...
			object o = RunCmdValue(cmd, SqlDbType.DateTime);
			if(o != null)
				ret = (DateTime)o;
			return ret;
		}
		...
		#region RunCmdInt32()
		public int RunCmdInt32(SqlCommand cmd)
		{
			int ret = -1;
			object o = RunCmdValue(cmd, SqlDbType.Int);
			if(o != null)
				ret = (int)o;
			return ret;
		}
		...
		#region RunCmdInt64()
		public long RunCmdInt64(SqlCommand cmd)
		{
			long ret = -1;
			object o = RunCmdValue(cmd, SqlDbType.BigInt);
			if(o != null)
				ret = (long)o;
			return ret;
		}
		...
		#region public object RunCmdValue(SqlCommand cmd, SqlDbType type)
		public object RunCmdValue(SqlCommand cmd, SqlDbType type)
		{
			if (cmd == null)
		...
		// Stored Procedure
		#region RunSP()
		public void RunSP(string cmdText, params SqlParameter[] parameters)
		{
			RunCmd(MakeCommand(CommandType.StoredProcedure, cmdText, parameters));
		}

		public SqlCommand RunSP(SqlCommand cmd, string cmdText, params SqlParameter[] parameters)
		{
			DemandTransaction();

			if(null == cmd)
				cmd = MakeCommand(CommandType.StoredProcedure, cmdText, parameters);
		...
		public IDataReader RunSPDataReader(string cmdText, params SqlParameter[] parameters)
		{
			return RunCmdDataReader(MakeCommand(CommandType.StoredProcedure, cmdText, parameters));
		}
		#endregion

		#region RunSPDataReaderBlob()
		public IDataReader RunSPDataReaderBlob(string cmdText, params SqlParameter[] parameters)
		{
			return RunCmdDataReaderBlob(MakeCommand(CommandType.StoredProcedure, cmdText, parameters));
		}
		#endregion

		#region RunSPDataTable()
		public DataTable RunSPDataTable(string cmdText, params SqlParameter[] parameters)
		{
			return RunCmdDataTable(MakeCommand(CommandType.StoredProcedure, cmdText, parameters));
		}
		#endregion

		#region RunSPDateTime()
		public DateTime RunSPDateTime(string cmdText, params SqlParameter[] parameters)
		{
			return RunCmdDateTime(MakeCommand(CommandType.StoredProcedure, cmdText, parameters));
		}
		#endregion

		#region RunSPInt32()
		public int RunSPInt32(string cmdText, params SqlParameter[] parameters)
		{
			return RunCmdInt32(MakeCommand(CommandType.StoredProcedure, cmdText, parameters));
		}
		#endregion

		#region RunSPInt64()
		public long RunSPInt64(string cmdText, params SqlParameter[] parameters)
		{
			return RunCmdInt64(MakeCommand(CommandType.StoredProcedure, cmdText, parameters));
		}
		#endregion

		#region RunSPScalar()
		public object RunSPScalar(string cmdText, params SqlParameter[] parameters)
		{
			return RunCmdScalar(MakeCommand(CommandType.StoredProcedure, cmdText, parameters));
		}
		#endregion
		...
		// Command Text
		#region RunText()
		public void RunText(string cmdText, params SqlParameter[] parameters)
		{
			RunCmd(MakeCommand(CommandType.Text, cmdText, parameters));
		}
		#endregion

		#region RunTextDataReader()
		public IDataReader RunTextDataReader(string cmdText, params SqlParameter[] parameters)
		{
			return RunCmdDataReader(MakeCommand(CommandType.Text, cmdText, parameters));
		}
		#endregion

		#region RunTextDataReaderSchemaOnly()
		public IDataReader RunTextDataReaderSchemaOnly(string cmdText, params SqlParameter[] parameters)
		{
			return RunCmdDataReader(MakeCommand(CommandType.Text, cmdText, parameters), CommandBehavior.SchemaOnly);
		}
		#endregion

		#region RunTextDataReaderBlob()
		public IDataReader RunTextDataReaderBlob(string cmdText, params SqlParameter[] parameters)
		{
			return RunCmdDataReaderBlob(MakeCommand(CommandType.Text, cmdText, parameters));
		}
		#endregion

		#region RunTextInt32()
		public int RunTextInt32(string cmdText, params SqlParameter[] parameters)
		{
			return RunCmdInt32(MakeCommand(CommandType.Text, cmdText, parameters));
		}
		#endregion

		#region RunTextScalar()
		public object RunTextScalar(string cmdText, params SqlParameter[] parameters)
		{
			return RunCmdScalar(MakeCommand(CommandType.Text, cmdText, parameters));
		}
		#endregion

		#region RunTextXmlDocument()
		public IXPathNavigable RunTextXmlDocument(string cmdText, params SqlParameter[] parameters)
		{
			return RunCmdXmlDocument(MakeCommand(CommandType.Text, cmdText, parameters));
		}
		#endregion
		...
		public static void RunScript(DbCommand cmd, TextReader script, NameValueCollection replace, bool catchSqlExceptions)
		{
			...
			while(!eof)
			{
				...
				{
					if(0 == string.Compare(line, "GO", StringComparison.OrdinalIgnoreCase))
						break;
