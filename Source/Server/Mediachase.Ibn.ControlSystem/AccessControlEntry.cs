...
namespace Mediachase.Ibn.ControlSystem
{
	...
	public class AccessControlEntry
	{
		...
		public AccessControlEntry(string role,string action, bool allow):this(0,false,role,0,action,allow,false)
		{
		}
		...
		/// <param name="action">The action.</param>
		/// <param name="allow">if set to <c>true</c> [allow].</param>
		public AccessControlEntry(int principalId,string action, bool allow):this(0,false,null,principalId,action,allow,false)
		{
		}
		...
		/// <returns></returns>
		internal static AccessControlEntry InternalCreate(int id, bool isInherited, string role,int principalId,string action, bool allow, bool isInternal)
		{
			return new AccessControlEntry(id, isInherited, role,principalId,action, allow, isInternal);
		}
		...
		/// <param name="allow">if set to <c>true</c> [allow].</param>
		/// <param name="isInternal">if set to <c>true</c> [is internal].</param>
		protected AccessControlEntry(int id, bool isInherited, string role,int principalId,string action, bool allow, bool isInternal)
		{
			_id = id;
